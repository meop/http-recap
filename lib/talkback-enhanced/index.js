...
var Tape = function () {
  ...
  _createClass(Tape, [{
    ...
    value: function sameRequestAs(tape) {
      ...
      var same = this.options.ignoreBody ? this.req.url === req.url && this.req.method === req.method : this.req.url === req.url && this.req.method === req.method && this.req.body.equals(req.body);
      if (!same) {
        return false;
      }
